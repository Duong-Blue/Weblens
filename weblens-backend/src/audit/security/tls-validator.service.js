...
exports.TlsValidatorService = void 0;
const common_1 = require("@nestjs/common");
let TlsValidatorService = class TlsValidatorService {
    checkTLS(tlsInfo) {
        const issues = [];
        if (!tlsInfo) {
            issues.push({
...
exports.TlsValidatorService = TlsValidatorService;
exports.TlsValidatorService = TlsValidatorService = __decorate([
    (0, common_1.Injectable)()
], TlsValidatorService);
//# sourceMappingURL=tls-validator.service.js.map